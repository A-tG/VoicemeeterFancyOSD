...
namespace VoicemeeterOsdProgram.Core.Types
{
    public class VoicemeeterNumParam : VoicemeeterParameterBase<float>
    {
        ...
        public override int GetParameter(out float val) => m_api.GetParameter(m_command, out val);

        public override int SetParameter(float value) => m_api.SetParameter(m_command, value);
    }
}
